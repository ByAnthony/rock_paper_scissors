...
def index():
    return render_template('index.html', title='Rock / Paper / Scissors - Play Against The Other You')

@app.route('/rock-paper-scissors/play/<choice_1>/')
def player_1_play(choice_1):
    return render_template('player_2.html', title='Rock / Paper / Scissors - Play Against The Other You', choice_1=choice_1)
...
def display_winner(choice_1, choice_2):
    ...
    return render_template('result.html', title='Rock / Paper / Scissors - Play Against The Other You', winner_is=winner_is, choice_1=choice_1, choice_2=choice_2)
...
def display_winner_vs_computer():
    ...
    return render_template('result_computer.html', title='Rock / Paper / Scissors - Play Against The Non-Human', winner_is=winner_is, player_choice=player_choice, computer_choice=computer_choice, computer_name=computer_name, player_name=player_name)